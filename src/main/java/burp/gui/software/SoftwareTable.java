...
class URLSelectionListener extends MouseAdapter{
    ...
    URLSelectionListener(BurpExtender burpExtender, TabComponent tabComponent, VulnTable vulnTable){
    ...
    public void mousePressed(MouseEvent event){
        ...
        if(row >= 0){
            ...
            this.vulnTable.refreshTable(d);
//            for(String o: d.getSoftware().keySet()){}
            burpExtender.printOutput("[VULNERS] Table view mouse pressed from " + s.toString());
            event.consume();
        }
...
public class SoftwareTable extends JTable {
    ...
    public SoftwareTable(BurpExtender burpExtender, TabComponent tabComponent, VulnTable vulnTable) {
        ...
        this.addMouseListener(new URLSelectionListener(burpExtender, tabComponent, vulnTable));
